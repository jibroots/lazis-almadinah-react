      ...
      <div className="w-full max-w-lg relative z-10 space-y-8">
        <div className="bg-slate-900/90 border border-slate-700 p-8 rounded-3xl shadow-2xl space-y-6">
          ...
          <div className="text-center space-y-3 animate-fadeIn border-b border-slate-800 pb-5">
            ...
            <h1 className="text-3xl font-extrabold text-white tracking-tight">LAZISWaf Al-Madinah</h1>
            <p className="text-emerald-400 font-extrabold text-xs uppercase tracking-widest">Sistem Informasi Badan Amal Masjid Al-Madinah</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-[10px] font-extrabold text-slate-200 uppercase tracking-wider block">Username</label>
