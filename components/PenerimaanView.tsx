        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm transition-opacity">
          <div className="bg-white w-full max-w-xl rounded-3xl overflow-hidden shadow-2xl border border-slate-100 animate-scaleUp">
            ...
            <div className="bg-emerald-600 text-white px-6 py-6 text-center space-y-2 relative">
              ...
              <h3 className="font-extrabold uppercase tracking-widest text-xs text-emerald-300">Kuitansi Resmi Digital</h3>
            ...
            <div className="p-6 space-y-6 text-slate-750">
              ...
              <div className="space-y-4 text-xs font-bold">
                ...
                <div className="flex justify-between items-start gap-4">
                  <span className="text-slate-500 font-bold flex items-center gap-1.5 shrink-0"><User className="w-3.5 h-3.5" /> Muzakki:</span>
                  <div className="text-right">
                    <span className="font-extrabold text-slate-800 block">{detailItem.namaMuzakki}</span>
                    {detailItem.nomorHp && <span className="text-[11px] text-slate-600 block mt-0.5">{detailItem.nomorHp}</span>}
                  </div>
                </div>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-extrabold text-slate-800">
                    {new Date(detailItem.tanggalPenerimaan).toLocaleDateString('id-ID', {
                      weekday: 'long',
                      day: 'numeric',
                      month: 'long',
                      year: 'numeric'
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-extrabold text-emerald-800 bg-emerald-50 px-2.5 py-0.5 rounded border border-emerald-150 uppercase text-[10px]">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-extrabold text-slate-800">{detailItem.metodePembayaran}</span>
                </div>
